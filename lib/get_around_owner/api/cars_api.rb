...
module GetAroundOwner
  class CarsApi
    ...
    # Find a car by ID
    # Find a car by ID
    # @param id [String] ID of car to return
    ...
    # @param id [String] ID of car to return
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetaroundCar, Integer, Hash)>] GetaroundCar data, response status code and response headers
    def get_car_by_id_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/cars/{id}.json'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetaroundCar'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['bearerAuth']

      new_options = opts.merge(
        :operation => :"CarsApi.get_car_by_id",
    ...
    # @return [Array<GetaroundCarsIndexInner>]
    def get_cars(opts = {})
      data, _status_code, _headers = get_cars_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :page Page number
    # @option opts [String] :per_page Page size (default to '30')
    # @return [Array<(Array<GetaroundCarsIndexInner>, Integer, Hash)>] Array<GetaroundCarsIndexInner> data, response status code and response headers
    def get_cars_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Array<GetaroundCarsIndexInner>'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['bearerAuth']

      new_options = opts.merge(
        :operation => :"CarsApi.get_cars",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
