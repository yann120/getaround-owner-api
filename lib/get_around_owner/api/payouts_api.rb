  ...
  class PayoutsApi
    ...
    def get_payouts_with_http_info(start_date, end_date, opts = {})
      ...
      if @api_client.config.client_side_validation && start_date.nil?
        fail ArgumentError, "Missing the required parameter 'start_date' when calling PayoutsApi.get_payouts"
      end
      # verify the required parameter 'end_date' is set
      if @api_client.config.client_side_validation && end_date.nil?
        fail ArgumentError, "Missing the required parameter 'end_date' when calling PayoutsApi.get_payouts"
      end
      # resource path
      local_var_path = '/payouts.json'
