...
module GetAroundOwner
  ...
  class GetaroundCar
    ...
    # Vehicle's brand (ex: Volkswagen)
    attr_accessor :brand

    # Vehicle's model (ex: Polo)
    attr_accessor :model
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `GetAroundOwner::GetaroundCar` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `GetAroundOwner::GetaroundCar`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @plate_number.nil?
        invalid_properties.push('invalid value for "plate_number", plate_number cannot be nil.')
      end
      ...
      if @display_address.nil?
        invalid_properties.push('invalid value for "display_address", display_address cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @plate_number.nil?
      return false if @brand.nil?
      return false if @model.nil?
      return false if @display_address.nil?
      true
    end
    ...
    def hash
      [id, state, plate_number, brand, model, display_address].hash
    end
