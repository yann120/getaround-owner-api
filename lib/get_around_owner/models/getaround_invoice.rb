  ...
  class GetaroundInvoice
    ...
    def self.openapi_types
      {
        ...
        :'currency' => :'String',
        :'entity_type' => :'String',
        :'charges' => :'Array<GetaroundInvoiceChargesInner>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `GetAroundOwner::GetaroundInvoice` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `GetAroundOwner::GetaroundInvoice`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      product_type_validator = EnumAttributeValidator.new('String', ["Rental"])
      ...
      entity_type_validator = EnumAttributeValidator.new('String', ["Company", "User"])
    ...
    def product_type=(product_type)
      validator = EnumAttributeValidator.new('String', ["Rental"])
    ...
    def entity_type=(entity_type)
      validator = EnumAttributeValidator.new('String', ["Company", "User"])
